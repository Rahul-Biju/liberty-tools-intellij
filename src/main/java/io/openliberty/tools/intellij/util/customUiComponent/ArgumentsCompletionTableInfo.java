...
public class ArgumentsCompletionTableInfo implements CompletionTableInfo {
    ...
    public Object collectTableCompletionInfo(@NotNull Continuation<? super List<TextCompletionInfo>> continuation) {
        ...
        List<TextCompletionInfo> completionInfoList = new ArrayList<>();

        completionInfoList.add(new TextCompletionInfo("dHotTest", "Test for hotTest", null));
        completionInfoList.add(new TextCompletionInfo("deBugPort", "Test for dBugPort", null));
